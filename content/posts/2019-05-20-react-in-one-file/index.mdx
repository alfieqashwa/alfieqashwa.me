...
2. Sisipkan tiga CDN di `head tag`: React, ReactDOM, Babel.
...
##### You can also change "Cello World!" with your own world 👇 below...

```js live
render(
  <h1 style={{ color: 'hotpink', textAlign: 'center' }}>Cello World!</h1>
)
```
