...
### JS No-Comments & No Line Highlight
...
const sentence = 'Novela is the best gatsby-theme' // 👈 try edit here

const Title = () => <h1 style={{ color: 'palevioletred' }}>{sentence}</h1>
render(
  <Wrapper>
    <h2 style={{ color: 'teal' }}>
      DO IT LIVE
      <h4>please change the sentence !</h4>
    </h2>
    <Title />
      <p>... in the <span img="role" style={{ fontSize: '10em'}}>🌏</span> :)</p>
  </Wrapper>
)
```
